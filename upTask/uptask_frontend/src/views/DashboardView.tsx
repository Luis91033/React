...
import DeleteProjectModal from "../components/proyects/DeleteProjectModal";
                    ...
                    >
                      <Menu.Items className="absolute right-0 z-10 mt-2 w-56 origin-top-right rounded-md bg-white py-2 shadow-lg ring-1 ring-gray-900/5 focus:outline-none ">
                        <Menu.Item>
                          <Link
                            to={`/projects/${project._id}/`}
                            className="block px-3 py-1 text-sm leading-6 text-gray-900 hover:font-bold"
                          >
                            Ver Proyecto
                          </Link>
                        </Menu.Item>
                        {project.manager === user._id && (
                          <>
                            ...
                            <Menu.Item>
                              <button
                                type="button"
                                className="block px-3 py-1 text-sm leading-6 text-red-500 hover:font-bold"
                                onClick={() =>
                                  navigate(
                                    location.pathname +
