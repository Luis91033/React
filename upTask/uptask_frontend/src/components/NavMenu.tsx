...
export default function NavMenu({ data }: NavMenuProps) {
  ...
  return (
    <Popover className="relative">
      <Popover.Button className="inline-flex items-center gap-x-1 text-sm font-semibold leading-6 p-1 rounded-lg bg-purple-400 hover:bg-purple-500 cursor-pointer">
